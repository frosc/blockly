 ...
 * @private
 */
Code.TABS_ = ['blocks', 'javascript', 'aseba', 'xml'];
...
Code.initLanguage = function() {
  ...
  var categories = ['catLogic', 'catLoops', 'catMath', 'catLists',
                    'catColour', 'catLeds', 'catSound', 'catComm', 'catSd', 'catVariables', 'catThymio2Vars', 'catFunctions'];
